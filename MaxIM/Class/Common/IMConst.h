...
extern NSString *const kRouterEventChatReadStatusLabelTapEventName;
extern NSString *const kRouterEventTextURLTapEventName;
extern NSString *const kRouterEventImageBubbleTapEventName;
extern NSString *const kRouterEventVideoBubbleTapEventName;
extern NSString *const kRouterEventVoiceBubbleTapEventName;
extern NSString *const kRouterEventLocationBubbleTapEventName;
extern NSString *const kRouterEventFileBubbleTapEventName;
extern NSString *const kRouterEventLongPressName;
