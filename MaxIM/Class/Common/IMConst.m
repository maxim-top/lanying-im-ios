...
CGFloat const kChatBarHeight = 49.0f;
...
NSString *const kRouterEventChatReadStatusLabelTapEventName = @"kRouterEventChatReadStatusLabelTapEventName";
...
NSString *const kRouterEventVoiceBubbleTapEventName = @"kRouterEventVoiceBubbleTapEventName";
...
NSString *const kRouterEventLongPressName = @"kRouterEventLongPressName";
NSInteger kMessageCount = 20;

#pragma mark - IM模块常量

// 头像大小
CGFloat const HEAD_SIZE = 43.0f;
...
// nameLabel 高度
CGFloat const NAME_LABEL_HEIGHT = 10.0f;
// nameLabel间距
