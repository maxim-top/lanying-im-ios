...
- (UITextField *)searchTF {
    if (!_searchTF) {
        ...
        _searchTF.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Enter_Friends_username_to_search", @"输入要查找的好友用户名或ID")attributes:@{NSForegroundColorAttributeName: BMXCOLOR_HEX(0x666666)}];
